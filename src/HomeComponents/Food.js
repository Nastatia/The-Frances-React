...
const Food = () => {
    return (
        <section className="m-0 h-auto food transition-transform duration-1000 ease-in-out   lg:px-40 md:px-10 sm:px-6 px-4">
            <div className="h-fit lg:py-20 md:py-10 sm:py-8 py-4">
                <div className="text-left justify lg:py-20 md:py-10 sm:py-8 py-4"> 
            ...
            <div className="justify-center py-20 flex items-center w-full overflow-hidden flex-col lg:py-20 md:py-10 sm:py-8 "> 
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-10 justify-items-center lg:py-20 md:py-4 sm:py-8 py-4"> 
                    ...
                    {[
                        ...
                        <div key={index} className="w-full border-opacity-10 border-black border-[1px] p-4 hover:bg-opacity-80 hover:bg-white  transition duration-300 rounded-xl text-center">
                            <a href="/create">
